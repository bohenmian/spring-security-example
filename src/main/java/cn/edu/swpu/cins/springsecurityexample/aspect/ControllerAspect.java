package cn.edu.swpu.cins.springsecurityexample.aspect;
...
public class ControllerAspect {
    ...
    private final Log logger = LogFactory.getLog(ControllerAspect.class);

    @Pointcut(value = "execution(public * cn.edu.swpu.cins.springsecurityexample.controller.*.*(..))")
